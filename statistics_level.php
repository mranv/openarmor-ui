...
#	Table "data" suppressed for OpenArmor V2.9 replaced by "alert"
require './top.php';
...
print("var chart;\n");
if ( $wheresource2 == "" )
{ 	include './php/detail_statistics.php';
} else
{	include './php/detail_statistics.php';
}
?>
...
// SERIAL CHART
	...
	graph2.type = "column";
	graph2.balloonText = "Current2 [[category]]:[[value]]";
	graph2.lineAlpha = 0;
	graph2.fillColors = "#25bf25";
	graph2.fillAlphas = 1;
	...
	graph3.type = "column";
	graph3.balloonText = "Previous2 [[category]]:[[value]]";
	graph3.lineAlpha = 0;
...
<!--  Filter display group 1 -->
    <form id='click2go' method='GET' action='./statistics_level.php' class="form-inline">
        <div class="row">
...
<!-- Group2 values -->
        <div class="row">
            ...
            <div class="col-lg-2 form-group">
<!--
                <input type='text' size='16' name='to' value='<?php echo $filterto; ?>'
                       class="form-control input-sm"/>
-->
            </div>
            <div class="col-lg-1 form-group">
...
<!-- Place to display graph -->
    ...
    <div class="row">
        <div id="chartdiv" style="width:100%; height:<?php echo $glb_height_stat_level ?>px;"></div>
    </div>
	<div>
	<?php 
