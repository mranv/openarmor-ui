...
#	Table "data" suppressed
        $querydelete = "DELETE alert FROM alert
			...
			WHERE " . $where;
### syntax error ### $resultdelete = mysql_query($querydelete, $db_OpenArmor);
...
<div class="container-fluid" style="padding-top: 60px;">
    ...
    <div style="padding:10px;">
        ...
        <div class="contents"><a href='./management.php#removelocation'>Remove Location (OpenArmor client)</a></div>
<!--
...
<!--    <br/> -->
    ...
    <div class="introbody">All of this reflects the data held in your SQL database and is not linked in anyway to the
        flat file logs written by OpenArmor.
    </div>

    <div class="introbody">This page is to help manage your OpenArmor database.</div>
        ...
        <div class="col-lg-4">
            <ul class="nav nav-pills" role="tablist" style="width: 100%; background-color: black; color: white;">
				<li role="presentation" class="active" style="width: 100%;">
					<a href="#" style="font-weight: 800; background-color: black; color: white;">Remove Location (OpenArmor client)</a>
				</li>
            </ul>
        </div>
    </div>
<!--    <br/> -->
    ...
    <div class="introbody">
        ...
        <li>This should only be used on locations that are will no longer connect to OpenArmor
        <li>If you accidentally remove a location, you will have to restart the OpenArmor service to re import, though all
