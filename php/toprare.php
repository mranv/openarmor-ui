...
# This will not be pretty.  A SQL command was made that worked, but due to indexing design flaws with the OpenArmor MYSQL schema the command took 10 minutes to run on a relatively new/empty database.
